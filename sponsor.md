...
<div id="main" class="alt">
  <section id="sponsor">
    <div class="inner">
      ...
      <a href="https://www.fisiolabfano.com/" target="_blank">
        <div class="box">
          <h4>Fisiolab</h4>
        </div>
      </a>
      <a href="https://www.facebook.com/profile.php?id=100026536880054" target="_blank">
        <div class="box">
          <h4>Tendax</h4>
        </div>
      </a>
      <a href="https://www.ristorantebiricocco.it/" target="_blank">
        <div class="box">
          <h4>Ristorante Biricocco</h4>
        </div>
      </a>
      ...
      <a href="https://www.facebook.com/autocarrozzeria.fossiepanaroni" target="_blank">
        <div class="box">
          <h4>Autocarrozzeria Fossi E Panaroni</h4>
        </div>
      </a>
      <a href="https://www.facebook.com/galdelliaccumulatori" target="_blank">
        <div class="box">
          <h4>G.G. Accumulatori</h4>
        </div>
      </a>
      <a href="https://www.farmaca.com/dettaglio-categoria/731/protoplasmina/" target="_blank">
        <div class="box">
          <h4>Protoplasmina - Farmaca International</h4>
        </div>
      </a>
